...
una regola ha $n$ subderivazioni, allora il nostro termine costruttore deve avere
...
\end{array}
\]
Le regole di tipo per questi nuovi termini sono mostrati nella
...
\trule{$\cor$-I$_2$}, \trule{$\cor$-E}, and \trule{$\cfalse$-E}, puoi vedere 
...
generale $A$. O in modo equivalente, nel lambda calcolo semplicemente 
tipizzato,non esiste un termine chiuso di tipo $A+(A\to 0)$. Non siamo ancora
...
\]
Questa \`e {\em not} una regola di logica proposizionale intuizionista, ma possiamo esplorare cosa succederebbe se dovessimo aggiungere una regola del genere. Innanzitutto, osserviamo che la regola della contraddizione \`e molto simile alla seguente:
