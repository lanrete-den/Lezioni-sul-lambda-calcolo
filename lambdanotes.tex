...
\begin{definition}[Completezza combinatoria]
  Una struttura applicativa $(\Aa,\app)$ \`e {\em combinatoriamente
    completo} se per ogni polinomio $t(x_1,\ldots,x_n)$ di $n\geq 0$
...
\begin{definition}[Algebra combinatoria]
...
\begin{example}
  ...
  algebra is non-banale, ossia ha pi\`u di un elemento.
  
  Eesempi simili sono ottenuti sostituendo $\eqb$ con $\eqbe$, e/o
...
\void{
Nota che tutti gli esempi soprastanti di algebra combinatoria sono o
banali o sintattici. Non \`e facile trovare un vero esempio ``matematico''
di algebra combinatoria. Vedremo come trovare tali modelli pi\`u tardi.
}
